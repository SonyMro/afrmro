...
function consultarReservacion(folio){
	...
	$.ajax({
		...
		success: function (result) {
			...
			console.log(respuesta.result.id);
			$('#hNombre').html(respuesta.result.responsable);
			$('#hInst').html(respuesta.result.instGrupo);
			$('#hMail').html(respuesta.result.mail);
			$('#hAdult').html(respuesta.result.NumAdultos);
			$('#hBoy').html(respuesta.result.NumNiños);
			$('#hServ').html(respuesta.result.servicios);
		},
